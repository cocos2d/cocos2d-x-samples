...
def main():
    ...
    fantasywarroir3d_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
    ...
    customoutput_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", 'frameworks', "runtime-src", "Classes", "custom"))
    ...
    config.set('DEFAULT', 'pluginxdir', customoutput_root)
    ...
    try:
        ...
        tolua_root = '%s/tolua' % fantasywarroir3d_root
        output_dir = '%s' % customoutput_root

        cmd_args = {'cocos2dx_custom.ini' : ('cocos2dx_custom', 'lua_cocos2dx_custom')}
        target = 'lua'
